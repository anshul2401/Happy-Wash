      ...
      appBar: AppBar(
       ...
       body: Container(
        ...
        child: ListView(
            ...
            children: [
              Text('How It Works?',style: TextStyle(fontSize: 30,fontFamily: 'Alegreya'),),
              SizedBox(height: 30,),
              Text('Turn any parking space into a mobile car wash with HappyWash mobile app at the time and place of your choice with following simple steps -',
             ...
             Row(
               children: [
                 ...
                 SizedBox(width: 20,),
                 Container(child: Text("Choose your vehicle type.",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),))
               ],
             ),
             SizedBox(height:10,),
              Divider(
