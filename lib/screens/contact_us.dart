    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
            ...
            children: [
              Text('Contact Us',style: TextStyle(fontSize: 30,fontFamily: 'Alegreya'),),
              SizedBox(height: 30,),
              Row(
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('PHONE',style: TextStyle(color: Color.fromRGBO(0, 127, 219, 1),fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'Alegreya'),),
                  SizedBox(height: 10,),
                  Text('+918989000910',style: TextStyle(fontSize: 18),)
                ],
              )
              ],),
              SizedBox(height: 30,),
              ...
              Column(
                ...
                children: [
                  ...
                  Text('EMAIL',style: TextStyle(color: Color.fromRGBO(0, 127, 219, 1),fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'Alegreya'),),
                  SizedBox(height: 10,),
                  Text('happywashops@gmail.com',style: TextStyle(fontSize: 18),)
                ],
              )
              ],)
